data "terraform_remote_state" "vpc_id" {
  ...
  config = {
    path = "../vpc/main.tf"  # Path to the .tfstate file generated by VPC script.
  }
}
...
data "terraform_remote_state" "kms_key" {
  backend = "local"  # If you are using a remote backend, specify it here (e.g., "gcs" for Google Cloud Storage).
  config = {
    path = "../kms/main.tf"  # Path to the .tfstate file generated by VPC script.
  }
}
...
data "terraform_remote_state" "sa" {
  backend = "local"  # If you are using a remote backend, specify it here (e.g., "gcs" for Google Cloud Storage).
  config = {
    path = "../service-account/main.tf"  # Path to the .tfstate file generated by VPC script.
  }
